        ...
        <div className="md:col-span-2 space-y-6">
          <section className="bg-white rounded-2xl border border-gray-100 p-8 shadow-sm">
            <div className="flex items-center gap-3 mb-4">
              ...
              <h2 className="text-xl font-bold text-gray-900">{t('about.history_title')}</h2>
            </div>
          ...
          <section className="bg-white rounded-2xl border border-gray-100 p-8 shadow-sm">
            <div className="flex items-center gap-3 mb-4">
              ...
              <h2 className="text-xl font-bold text-gray-900">{t('about.mission_title')}</h2>
            </div>
          ...
          <section className="bg-white rounded-2xl border border-gray-100 p-8 shadow-sm">
            <div className="flex items-center gap-3 mb-6">
              ...
              <h2 className="text-xl font-bold text-gray-900">{t('about.team_title')}</h2>
            </div>
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div className="p-4 rounded-xl border border-gray-50 bg-gray-50/50 flex items-start gap-4">
                ...
                <div>
                  <h4 className="font-bold text-gray-900">{t('about.ceo_name')}</h4>
                  <p className="text-xs text-blue-600 font-medium">{t('about.ceo_role')}</p>
                </div>
              </div>
              <div className="p-4 rounded-xl border border-gray-50 bg-gray-50/50 flex items-start gap-4">
                <div className="w-12 h-12 rounded-full bg-gray-200 flex-shrink-0 flex items-center justify-center text-gray-500 font-bold text-lg">
                ...
                <div>
                  <h4 className="font-bold text-gray-900">{t('about.sales_director_name')}</h4>
                  <p className="text-xs text-blue-600 font-medium">{t('about.sales_director_role')}</p>
                </div>
              </div>
            </div>
          </section>
